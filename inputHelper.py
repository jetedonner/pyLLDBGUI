...
#import lldb.SBDebugger
#import lldb.SBDebugger.SBInputReader
...
class FBInputHandler:
	...
	def __init__(self, debugger, callback):
		...
		self.inputReader = SBInputReader()
		self.inputReader.Initialize(debugger, self.handleInput, lldb.eInputReaderGranularityLine, None, None, True)
