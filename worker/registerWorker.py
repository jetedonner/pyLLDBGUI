...
interruptRegisterLoad = False

class RegisterLoadReceiver(QObject):
	interruptRegisterLoad = pyqtSignal()
	
class RegisterLoadWorkerSignals(QObject):
	finished = pyqtSignal()
...
#			print(str(error_ref))
	...
	def runRegisterLoad(self):
		if self.isRegisterLoadActive:
			interruptRegisterLoad = True
			return
		else:
			interruptRegisterLoad = False
		QCoreApplication.processEvents()
...
#		print(result.GetSummary())
	...
	def handle_interruptRegisterLoad(self):
